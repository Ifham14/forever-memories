                            ...
                            <div class="rounded-lg p-4 shadow-[0_4px_12px_rgba(0,0,0,0.1)] bg-white transition hover:shadow-[0_6px_16px_rgba(0,0,0,0.15)]">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        {{-- Delete --}}
                                        <a href="#" 
                                        onclick="event.preventDefault(); if (confirm('Are you sure you want to delete this note?')) document.getElementById('delete-form-{{ $notebook->id }}').submit();"
                                        class="flex items-center space-x-1 border border-gray-300 text-gray-700 rounded-full px-3 py-1.5 text-sm hover:bg-gray-100 transition">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <form id="delete-form-{{ $notebook->id }}" 
                                            action="{{ route('notebook.destroy', $notebook->id) }}" 
                                            method="POST" 
                                            class="hidden">
                                            @csrf
                                            @method('DELETE')
