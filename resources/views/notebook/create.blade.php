            ...
            <form action="{{ route('notebook.store') }}" enctype="multipart/form-data" method="POST" class="w-full max-w-5xl bg-white rounded-lg shadow-lg p-10 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="story" rows="6" placeholder="Write your notebook entry..." class="w-full rounded-2xl border border-gray-300 px-4 py-2 focus:ring focus:ring-blue-200 focus:outline-none resize-none"></textarea>
                    </div>
                </div>
                ...
                <div class="mt-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="honorary_pallbearers" placeholder="Enter mentions" class="w-full rounded-full border border-gray-300 px-4 py-2 focus:ring focus:ring-blue-200 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Place / Event</label>
                            <input type="text" name="interment" placeholder="Enter place or event" class="w-full rounded-full border border-gray-300 px-4 py-2 focus:ring focus:ring-blue-200 focus:outline-none">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Gratitude Notes</label>
                            <textarea name="grateful_hearts" rows="6" placeholder="Write your gratitude here..." class="w-full rounded-2xl border border-gray-300 px-4 py-2 focus:ring focus:ring-blue-200 focus:outline-none resize-none"></textarea>
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Final Notes</label>
                            <input type="text" name="final_arrangement_entrusted_to" placeholder="Enter final notes" class="w-full rounded-full border border-gray-300 px-4 py-2 focus:ring focus:ring-blue-200 focus:outline-none">
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8">
                    <button type="submit" class="bg-[#FCDA98] hover:bg-[#ffc248] px-5 py-2 rounded cursor-pointer">Save Notebook</button>
                    <a href="{{ route('notebook.index') }}" class="ml-4 text-sm text-gray-600 hover:underline cursor-pointer">Cancel</a>
                </div>
            </form>
        </div>
    </div>
